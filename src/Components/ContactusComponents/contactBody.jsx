      ...
      <section className="container mx-auto px-4">
        <div className="mt-32">
          ...
          <p className="text-xl font-medium leading-7 text-[#556987] mt-7">
            We are here to help you with professional product photography and
        ...
        <div className="flex justify-between mt-12 flex-col xl:flex-row ">
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <a
                href="mailto:contact@productpaparazzi.co.uk"
                className="text-xl font-medium break-words"
              >
                contact@productpaparazzi.co.uk
              </a>
            </div>
            <div>
              <Contact_phone />
              <h2 className="mt-4 text-3xl font-bold">Phone</h2>
              <a href="tel:++44 1234 567890" className="text-xl font-medium">
                +44 (0) 1582 551 550
              </a>
            </div>
          ...
          <div className="lg:w-[48.875rem] relative">
            <HubSpotForm />
          </div>
        </div>
      </section>
